...
-- 6. Оценки
INSERT INTO [Sooritus] ([Matrikkel_nr], [OppeaineID], [Semester], [Too_liik], [Hinne]) VALUES 
(1, 1, 1, 'Eksam', 'Väga hea'),
(1, 2, 1, 'Eksam', 'Väga hea'),
(1, 3, 1, 'Eksam', 'Väga hea'),
(2, 1, 1, 'Eksam', 'Hea'),
(2, 2, 1, 'Eksam', 'Väga hea'),
(2, 3, 1, 'Eksam', 'Hea'),
(3, 1, 1, 'Eksam', 'Väga hea'),
(3, 2, 1, 'Eksam', 'Väga hea'),
(3, 3, 1, 'Eksam', 'Rahuldav');